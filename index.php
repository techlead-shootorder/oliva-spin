    ...
    <head>
        ...
        fbq('init', '350894201726539');
        fbq('track', 'PageView');
        </script>
        <noscript><img height="1" width="1" style="display:none"
        src="https://www.facebook.com/tr?id=350894201726539&ev=PageView&noscript=1"
        /></noscript>
        <!-- End Meta Pixel Code -->
    ...
    <body class="min-h-screen object-cover" style="background: url('images/BG.png')" >
                    ...
                    <form id="phoneLoginForm" class="space-y-4">
                        <div>
                            <input 
                                ...
                                required
                            >
                            <p class="text-xs text-gray-500 mt-1">Enter your full name (no numbers or special characters)</p>
                        </div>
        ...
        <script>
            ...
            // Log captured parameters on page load
            console.log('🔍 UTM Parameters Captured:', utmParameters);
            console.log('🌐 Browser Info Captured:', browserInfo);
            ...
            async function createLeadInZoho(mobile, couponCode, prize, userName = '') {
                try {
                    ...
                    console.log('🚀 Create Lead API Payload:', payloadData);
                    ...
                    console.log('✅ Create Lead API Response:', result);
            ...
            // Clear error message on input and validate name in real-time
            document.getElementById('nameInput').addEventListener('input', function(e) {
                document.getElementById('phoneError').textContent = '';
                
                // Remove any numbers or special characters as user types
