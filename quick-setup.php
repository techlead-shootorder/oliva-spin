<?php
// Quick setup script to create config.php with your known credentials
echo "Creating config.php with your database credentials...\n";
...
if (file_put_contents('api/config.php', $configContent)) {
    ...
    try {
        ...
        echo "✅ Default coupons loaded!\n";
        echo "\n🎯 Setup complete! You can now:\n";
        echo "- Login at: login.php\n";
        echo "- Access admin at: admin.php\n";
        echo "- Test spin at: index.php?recordedId=test123\n";
        echo "\n🔑 Login credentials:\n";
        echo "Username: admin\n";
    ...
    echo "❌ Failed to create config file. Check permissions.\n";
}
?>